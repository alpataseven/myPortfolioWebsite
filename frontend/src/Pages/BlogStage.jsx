        ...
        <>
            ...
            <div className="max-w-10xl mx-auto px-4 sm:px-6 py-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    <main className="lg:w-2/3"> {/*sayfanın 2/3 ünü kapsayacak şekilde ayarlamak için*/}
                        <div className="rounded-lg shadow-sm p-6 mb-8"> {/*cardların gözükeceği alan*/}
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 mt-8">
                                <div className="flex flex-wrap gap-2"> {/*flex wrap arastir*/}
                                    {categories.map((tab) => (
                                        <button
                                            key={tab}
                                            onClick={() => {
                                            ...
                                            className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${selectedCategory === tab
                                ...
                                <div className="flex gap-3">
                                    ...
                                    >
                                        <option value="default">Filtrele</option>
                        ...
                        <div style={{ marginTop: "1.5rem" }} className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            {sortedPosts.slice(0, visibleCount).map((post) => (
                                <div key={post.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                                    ...
                                    />
                                    <div className="p-6">
                                        <span style={{ marginBottom: "5px" }} className="inline-block px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full mb-3">
                                            {post.category}
                                        </span>
                                        ...
                                        <p style={{ marginBottom: "10px" }} className="text-gray-600">{post.description}</p>
                    ...
                    <aside className="lg:w-1/3 space-y-6">
                        ...
                        <div style={{ marginTop: "1.5rem" }} className="rounded-lg shadow-sm p-6">
                            <h3 style={{ marginBottom: "1rem" }} className="text-lg font-bold">Son Yazılar</h3>
                            <ul className="space-y-3">
                                {latestPosts.map((post) => (
                                    <li style={{ marginBottom: "1rem" }} key={post.id} className="flex gap-3">
                                        <img
                                            src={post.image}
                                            alt={post.title}
                        ...
                        <div style={{ marginTop: "1.5rem" }} className="bg-white rounded-lg shadow-sm p-6">
                            <h3 style={{ marginBottom: "1rem" }} className="text-lg font-bold text-gray-900 mb-4">Etiketler</h3>
